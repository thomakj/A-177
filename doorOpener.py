...
sudi = "78:7E:61:30:8D:E3"


#Kristian, Orjan, Thomas, Sudi
signals = [-999,-999,-999, -999]
...
while 1==1:
    ...
    for line in inputFile.read().splitlines():
	    ...
	    signalStrength = var[:(len(var)-1)]
            signalStrength = int(float(signalStrength))
	    print ("Sudi: " + str(signalStrength))
            if (signalStrength > signals[3] and signalStrength < -55 and signalStrength > -70):
	        print "open for Sudi"
                openDoor = 1
            signals[3] = signalStrength
    if openDoor == 1:
